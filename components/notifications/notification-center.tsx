            ...
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  {isFr
                    ? "Éléments actuellement présents dans votre centre de notifications."
          ...
          <CardContent className="px-5 py-5">
            <div className="flex items-start justify-between gap-3">
              <div>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  {isFr
                    ? "Éléments qui attendent encore votre attention."
          ...
          <CardContent className="flex h-full flex-col justify-between gap-4 px-5 py-5">
            <div>
              ...
              <h3 className="mt-2 text-lg font-semibold tracking-tight">
                {isFr ? "Gardez le flux propre" : "Keep the feed clean"}
              </h3>
              <p className="mt-2 text-sm text-muted-foreground">
                {isFr
                  ? "Utilisez les états lu et archivé pour garder le centre ciblé et exploitable."
                  : "Use read and archive states to keep the center focused and actionable."}
              </p>
            </div>
