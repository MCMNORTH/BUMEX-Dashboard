        ...
        <CardContent className="relative space-y-4 px-4 py-4 sm:px-5">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2.5">
              ...
              <Badge variant="secondary" className="rounded-full border-0 bg-primary px-3 py-1 text-[11px] text-primary-foreground shadow-sm transition-colors group-hover:bg-blue-700">
